...
_generate_infra_files() {
    ...
    envsubst_files ".env" '${SCRIPT_USER_EMAIL},${SCRIPT_DOMAIN},${SCRIPT_DOC_ROOT_DIR},${SCRIPT_DOCKER_PATH},${SCRIPT_COMPOSE_PROFILES},${SCRIPT_COMPOSE_FILE},${SCRIPT_JS_RUNTIME_MINIMAL_IMAGE},${SCRIPT_JS_RUNTIME_IMAGE},${SCRIPT_JS_RUNTIME_USER},${SCRIPT_COMMAND_RUNNER},${SCRIPT_DEV_CMD},${SCRIPT_BUILD_CMD},${SCRIPT_START_CMD}'
