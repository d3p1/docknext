...
_generate_infra_files() {
    ...
    envsubst_files ".env" '${SCRIPT_USER_EMAIL},${SCRIPT_DOMAIN},${SCRIPT_TRAEFIK_VERSION},${SCRIPT_HOST_DOC_ROOT_DIR},${SCRIPT_REMOTE_DOC_ROOT_DIR},${SCRIPT_NODE_VERSION},${SCRIPT_BUN_VERSION},${SCRIPT_DOCKER_PATH},${SCRIPT_COMPOSE_PROFILES},${SCRIPT_COMPOSE_FILE},${SCRIPT_JS_COMMAND_RUNNER},${SCRIPT_JS_COMMANDX_RUNNER},${SCRIPT_DEV_CMD},${SCRIPT_BUILD_CMD},${SCRIPT_START_CMD}'
